                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                      ...
                      <div className="lg:col-span-1">
                          ...
                          <p className="text-primary-foreground/80 mb-6 leading-relaxed">
                              The world's most intelligent auction platform,
                              where AI meets trust to create extraordinary
                  ...
                  <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                      <div>
                          ...
                          <p className="text-primary-foreground/80 text-sm">
                              Get exclusive access to premium auctions and AI
                              insights
                          </p>
                      </div>
              ...
              <div className="border-t border-primary-foreground/10 py-6">
                  <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                      <div className="flex items-center space-x-4">
                          <Badge
                              variant="outline"
                              className="border-accent/20 text-accent bg-transparent"
                          >
                              AI-Powered
                          </Badge>
                          <Badge
                              variant="outline"
                              className="border-success/20 text-success bg-transparent"
                          >
                              99.9% Uptime
                          </Badge>
                          <Badge
                              variant="outline"
                              className="border-primary-foreground/20 text-primary-foreground bg-transparent"
                          >
                              SOC 2 Certified
                          </Badge>
                      </div>
